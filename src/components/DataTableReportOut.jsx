...
// - If finishDate === nowDate && paymentStatus === "paid" && status === "done" || status === "taken"
                ...
                <div className="h-full max-lg:w-[58.33rem]">
                    ...
                    >
                        ...
                        {paginatedTransactions.length > 0 ? (
                            ...
                            <Typography className="p-4 text-center">{t("dataTableReportOut.blank")}</Typography>
                        )}
                    </Card>
                </div>
            </section>
