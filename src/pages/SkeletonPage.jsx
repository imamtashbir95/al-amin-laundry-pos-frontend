                                ...
                                <Card sx={{ backgroundColor: "#ffffff" }}>
                                    <div className="">
                                        <div className="relative flex h-[4.167rem] flex-row items-center p-[2.083rem]">
                                            <CardContent>
                                                <SkeletonButton width={"20rem"} height={"2rem"} />
                                            </CardContent>
                                            <CardActions className="absolute right-[2.083rem]">
                                                <SkeletonButton width={128.5} height={30.75} />
                                            </CardActions>
                                        </div>
                                    ...
                                    <div className="flex px-[0.83rem]">
                                        <div className="flex w-[25%] items-center justify-center">
                                            <SkeletonButton width={66} height={19.5} />
                                        </div>
                                        <div className="w-[25%]">
                                        ...
                                        <div className="flex w-[25%] items-center justify-center gap-[1rem]">
                                            {[...Array(2)].map((_, index) => (
                                                <SkeletonButton key={index} width={64} height={30.75} />
                                            ))}
                                        </div>
                                    </div>
                                </Card>
